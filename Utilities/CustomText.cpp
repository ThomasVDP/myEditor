...
////////////////////////////////////////////////////////////
CustomText::CustomText(const String& string, const Font& font, unsigned int characterSize) :
m_string             (string),
m_font               (&font),
...
CustomText::CustomText(const sf::String& string, const Font& font, unsigned int characterSize, const Color& fillColor, style_collection style) :
m_string             (string),
m_font               (&font),
m_characterSize      (characterSize),
m_letterSpacingFactor(1.5f),
...
////////////////////////////////////////////////////////////
void CustomText::setString(const String& string)
{
    if (m_string != string)
    {
        m_string = string;
...
////////////////////////////////////////////////////////////
void CustomText::setFont(const Font& font)
{
    if (m_font != &font)
    {
        m_font = &font;
...
////////////////////////////////////////////////////////////
void CustomText::setCharacterSize(unsigned int size)
{
...
////////////////////////////////////////////////////////////
void CustomText::setLetterSpacing(float spacingFactor)
{
...
////////////////////////////////////////////////////////////
void CustomText::setLineSpacing(float spacingFactor)
{
...
////////////////////////////////////////////////////////////
void CustomText::setStyle(style_collection style)
{
    if (m_style != style)
    {
        m_style = style;
...
void CustomText::addStyle(Uint32 style)
{
	bool add = true;
	bool removeRegular = false;
	for(unsigned int i = 0; i < m_style.size(); i++)
	{
		...
		if (m_style[i] == Regular)
		{
			removeRegular = true;
		}
	}
	if (removeRegular) m_style.erase(m_style.begin());
	if (add) m_style.push_back(style);
}

void CustomText::removeStyle(Uint32 style)
{
	int removeIndex = 0;
	bool remove = false;
	for (unsigned int i = 0; i < m_style.size(); i++)
	...
	if (remove) m_style.erase(m_style.begin() + removeIndex);
	if (m_style.size() == 0) m_style.push_back(Regular);
}

////////////////////////////////////////////////////////////
void CustomText::setFillColor(const Color& color)
{
...
////////////////////////////////////////////////////////////
void CustomText::setOutlineColor(const Color& color)
{
...
////////////////////////////////////////////////////////////
void CustomText::setOutlineThickness(float thickness)
{
...
////////////////////////////////////////////////////////////
const String& CustomText::getString() const
{
    return m_string;
}
...
////////////////////////////////////////////////////////////
const Font* CustomText::getFont() const
{
    return m_font;
}
...
////////////////////////////////////////////////////////////
unsigned int CustomText::getCharacterSize() const
{
...
////////////////////////////////////////////////////////////
float CustomText::getLetterSpacing() const
{
...
////////////////////////////////////////////////////////////
float CustomText::getLineSpacing() const
{
...
////////////////////////////////////////////////////////////
CustomText::style_collection CustomText::getStyle() const
{
    return m_style;
}
...
////////////////////////////////////////////////////////////
const Color& CustomText::getFillColor() const
{
    return m_fillColor;
}
...
////////////////////////////////////////////////////////////
const Color& CustomText::getOutlineColor() const
{
...
////////////////////////////////////////////////////////////
float CustomText::getOutlineThickness() const
{
...
////////////////////////////////////////////////////////////
Vector2f CustomText::findCharacterPos(std::size_t index) const
{
    ...
    for(unsigned int i = 0; i < m_style.size(); i++)
    {
		if (m_style[i] == sf::CustomText::Bold)
		{
			isBold = m_style[i] & Bold;
			break;
		}
	}
...
////////////////////////////////////////////////////////////
FloatRect CustomText::getLocalBounds() const
{
...
////////////////////////////////////////////////////////////
FloatRect CustomText::getGlobalBounds() const
{
    return getTransform().transformRect(getLocalBounds());
}


void CustomText::setBackGroundColor(const sf::Color& color, float height)
{
...
const sf::Color* CustomText::getBackGroundColor() const
{
	return m_backGroundColor;
}

void CustomText::clearBackGround()
{
	m_backGroundColor = NULL;
}
...
////////////////////////////////////////////////////////////
void CustomText::draw(RenderTarget& target, RenderStates states) const
{
    if (m_font)
    {
        ensureGeometryUpdate();
		...
		{
			sf::RectangleShape background(sf::Vector2f(getGlobalBounds().width + 1, backgroundHeight));
...
////////////////////////////////////////////////////////////
void CustomText::ensureGeometryUpdate() const
{
    if (!m_font)
        return;
    ...
    bool  isBold = 0;
    bool  isUnderlined = 0;
    bool  isStrikeThrough = 0;
    float italicShear = 0.f; // 12 degrees in radians
    for(unsigned int i = 0; i < m_style.size(); i++)
    {
		if (m_style[i] == sf::CustomText::Bold)
		{
			isBold = m_style[i] & Bold;
		} else if (m_style[i] == sf::CustomText::Underlined)
		{
			isUnderlined = m_style[i] & Underlined;
		} else if (m_style[i] == sf::CustomText::StrikeThrough)
		{
			isStrikeThrough = m_style[i] & StrikeThrough;
		} else if (m_style[i] == sf::CustomText::Italic)
		{
			italicShear = (m_style[i] & Italic) ? 0.209f : 0.f;
		}
	}
