...
sf::StandardCursor::StandardCursor(const sf::StandardCursor::TYPE t)
{
	switch(t)
	{
		...
		case sf::StandardCursor::TEXT:
			...
			break; //more cursor go http://msdn.microsoft.com/en-us/library/ms648391%28v=vs.85%29.aspx
	}
}
...
sf::StandardCursor::StandardCursor(const sf::StandardCursor::TYPE t)
{
	...
	switch(t)
	{
		...
		case sf::StandardCursor::TEXT:
			...
			break; //for more cursors unix visit: http://www.tronche.com/gui/x/xlib/appendix/b/
	}
}
